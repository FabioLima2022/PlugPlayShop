...
register_shutdown_function(function(){
  ...
  if ($fatal && !$GLOBALS['__out_advreg']) {
    if (!headers_sent()) { http_response_code(500); }
    echo '<!DOCTYPE html><html lang="pt-br"><head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1" /><title>Erro • Cadastro Anunciante</title><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap" rel="stylesheet"><link rel="stylesheet" href="assets/css/styles.css" /></head><body><header class="site-header"><div class="container header-inner"><div class="brand"><span class="logo">🤝</span><span class="name">Anunciante</span></div><nav class="actions"><a class="btn" href="index.php">Voltar à loja</a><a class="btn" href="advertiser_login.php">Entrar</a></nav></div></header><main class="container">';
    echo '<div class="notice error">Falha ao carregar página de cadastro.</div>';
    echo '</main></body></html>';
  }
});
$db = get_db_soft();
...
<body>
  <header class="site-header">
    <div class="container header-inner">
      <div class="brand">
        ...
        <span class="name">Anunciante</span>
      </div>
      <nav class="actions">
        <a class="btn" href="index.php">Voltar à loja</a>
        <a class="btn" href="affiliate_login.php">Entrar como anunciante</a>
        <a class="btn" href="affiliate_forgot.php">Recuperar senha</a>
      </nav>
    </div>
  </header>
  <?php $__out_advreg = true; ?>
  <main class="container">
    ...
    <form method="post" action="stripe_checkout.php" class="form" style="max-width:520px;">
      ...
      <input type="hidden" name="origin" value="advertiser" />
      <div class="form-row">
